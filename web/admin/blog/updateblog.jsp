                    ...
                    <div class="row">
                        <div class="col l-8">
                            <div class="single-form">
                                <p>Chỉnh sửa tiêu đề bài viết: </p>
                                <textarea class="txt-title" name="title" rows="4" cols="50">${b.getTitle()}</textarea>
                            </div>

                            <div class="single-form">
                                <p>Chỉnh sửa nội dung bài viết: </p>
                                <textarea name="content" rows="4" cols="50">${b.getContent()}</textarea>
                            </div>
